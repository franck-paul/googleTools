...
L10n::$locales['This site use Google Analytics cookies in order to tracking visits. If you want to avoid this, click <a href="javascript:gaOptout()">here</a>.'] = 'Ce site utilise des cookies Google Analytics pour suivre vos visites. Si vous voulez éviter ceci, cliquer sur ce <a href="javascript:gaOptout()">lien</a>.';
L10n::$locales['No Google Analytics cookies will be created for tracking your visits on this site.'] = 'Aucun cookie Google Analytics ne sera créé pour suivre vos visites sur ce site.';
